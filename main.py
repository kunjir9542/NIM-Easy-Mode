...
def titleScreen():
    ...
    if beginning == "R":
        ...
        print("Each player will take turns taking a number of pieces out of the total pieces. This number cannot exceed half of the remaining pieces")
        print("The objective of the game is to not be the person to take out the last piece. If you are this person, you lose. Have fun!")
...
def computerTurn():
    ...
    print("There are " + str(totalPieces) + " pieces remaining")
    takePieces = randint(1, int(totalPieces / 2))
